                ...
                <TABLE cellSpacing=0 cellPadding=3 width=165 align=center border=0>
                    ...
                    <TR>
                        <TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
                                class=span id=table_1Span>＋</SPAN> 用户列表
                        </TD>
                    </TR>
                    <TR>
                        <TD>
                                ...
                                <s:iterator var="user" value="#session.list">
                                    <TR>
                                        <TD class=menuSmall><A class=style2
                                                               href="${ pageContext.request.contextPath }/user_chatList?user_name=<s:property value="#user.userName"/>&user_id=<s:property value="#user.user_id"/>"
                                                               target=main>－ <s:property value="#user.userName"/> </A>
                                        </TD>
                                        <TD>
                                            &nbsp;&nbsp;
                                            <a href="${pageContext.request.contextPath }/user_delet?user_id=<s:property value="#user.user_id"/>">删除</a>
                                        </TD>
                                    </TR>
                                </s:iterator>
                                <TR>
                                    <TD>
                                        <a href="${pageContext.request.contextPath }/user_refreshMenu">& 刷新用户列表 &</a>
                                    </TD>
                                </TR>
                                </TBODY>
                            </TABLE>
                    ...
                    <TR>
                        <TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
                                class=span id=table_2Span>＋</SPAN> 用户管理
                        </TD>
                    </TR>
                    <TR>
                        <TD>
                            <TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${ pageContext.request.contextPath }/debug.jsp"
                                                           target=main>－ DEBUG </A>
                                    </TD>
