...
public class TuringAES {
	 ...
	 */
	public TuringAES(final String key) {
		this(key, 128);
	}
	 ...
	 */
	public TuringAES(final String key, final int bit) {
		this(key, bit, null);
	}
	 ...
	 */
	public TuringAES(final String key, final int bit, final String iv) {
		if (bit == 256) {
